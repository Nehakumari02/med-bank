...
const Customer: NextPage<CustomerType> = ({ className = "" }) => {
  return (
    <div
      className={`h-[1024px] w-[130px] bg-white border-darkslategray-400 border-r-[1px] border-solid box-border overflow-hidden shrink-0 flex flex-col items-center justify-start pt-[35px] px-6 pb-10 gap-[57px] text-left text-base text-dark-text-color-2 font-roboto mq450:pt-5 mq450:pb-5 mq450:box-border mq1000:hidden mq1000:pt-[23px] mq1000:pb-[26px] mq1000:box-border ${className}`}
    >
      <img
        className="w-20 h-20 relative object-cover"
        loading="lazy"
        alt=""
        src="/dashboard/clip-path-group@2x.png"
      />
      <div className="self-stretch flex-1 flex flex-col items-center justify-between py-0 px-[19px]">
          ...
          <div className="self-stretch flex flex-col items-start justify-start gap-1">
            ...
            <div className="w-[43px] rounded-10xs bg-white flex flex-row items-center justify-center py-2 px-3 box-border">
              <img
                ...
                loading="lazy"
                alt=""
                src="/dashboard/carbonorderdetails.svg"
              />
            </div>
            <div className="w-[43px] rounded-10xs bg-white flex flex-row items-center justify-center py-2 px-3 box-border">
              <img
                ...
                loading="lazy"
                alt=""
                src="/dashboard/fluentpayment32regular.svg"
              />
            </div>
            <div className="w-[43px] rounded-10xs bg-white flex flex-row items-center justify-center py-2 px-3 box-border">
              <img
                ...
                loading="lazy"
                alt=""
                src="/dashboard/materialsymbolslightarchiveoutline.svg"
              />
            </div>
          </div>
        </div>
        <div className="flex flex-col items-center justify-start gap-4">
          <img
            ...
            loading="lazy"
            alt=""
            src="/dashboard/uilsetting.svg"
          />
          <img
            className="w-[18px] h-[18px] relative overflow-hidden shrink-0"
            loading="lazy"
            alt=""
            src="/dashboard/enter.svg"
          />
        </div>
      </div>
    </div>
