...
import SamplesSkeleton from "./SamplesSkeleton"
...
export const SamplesDataTable: React.FC<OrdersDataTableProps> = ({ data=[], loading, totalPages, currentPage, setCurrentPage, buttons, searchQuery, setSearchQuery }) => {
