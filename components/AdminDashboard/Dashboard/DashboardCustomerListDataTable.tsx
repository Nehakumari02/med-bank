...
import CustomersSkeleton from "../Customers/CustomersSkeleton"
...
export const DashboardCustomerListDataTable: React.FC<DashboardDataTableProps> = ({ data=[], loading, searchQuery, setSearchQuery }) => {
